...
const MatchCard: React.FC<MatchCardProps> = ({ title, tags, date, location, positions }) => {
  return (
    <div className="border rounded-2xl shadow p-4 mb-4 w-full bg-white">
      ...
      <button className="mt-2 w-full bg-blue-600 text-white py-1.5 rounded-xl hover:bg-blue-700 transition">応募する</button>
    </div>
  );
};
